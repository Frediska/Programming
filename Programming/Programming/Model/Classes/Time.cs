...
namespace Programming.Model.Classes
{
    ...
    public class Time
    {
        ...
        /// Должно быть в промежутке от 0 до 23.</param>
        /// <param name="minutes">Количество минут. Должно быть положительным числом.
        /// Должно быть в промежутке от 0 до 59.</param>
        ...
        /// Должно быть в промежутке от 0 до 23.
        /// </summary>
        public int Hours
        {
            get 
        ...
        /// Должно быть в промежутке от 0 до 59.
        /// </summary>
        public int Minutes
        {
            get 
